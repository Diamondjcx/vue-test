;(function (config) {
  ...
  g.c.add = g.BuryPoint.add = function (a, b, c) {
    a.B5 || a.C || !(a = a.CLASS_NAME) || ((a = a.replace('AMap.', '')), g.BA.np(a, b, c))
  }
  var oc = {
    lang: 1,
    baseRender: 1,
  ...
  g.da.extend = g.da.extend = function (a) {
    ...
    function c() {
      ...
      if (!d && this.Ni) {
        ...
        for (
          var b = document.head || document.getElementsByTagName('head')[0], c = null, e = 0, f = b.childNodes.length;
          e < f;
          e++
        )
  ...
  g.va = {
    ...
    we: function (a, b, c) {
      ...
      if (b && c) {
        if (d && a in d && d[a])
          for (var e = 0; e < d[a].length; e += 1) if (d[a][e].yb === b && d[a][e].cf === c) return !0
        return !1
      }
    ...
    r: function (a, b) {
      ...
      void 0 !== b &&
        (b instanceof Array
          ...
          : 'string' === typeof b || 'number' === typeof b || 'boolean' === typeof b
          ? (c.value = b)
          : g.a.HJ(b)
          ? (c.value = b)
          : (c = g.extend(c, b)))
      for (var d = [].concat(this.nf[a]), e = 0; e < d.length; e += 1)
        d[e].yb && (d[e].yb.call(d[e].cf || this, c), d[e] && d[e].Dj && this.nf[a] && this.nf[a].splice(e, 1))
      return this
    },
    ui: function (a) {
  ...
  g.$e = {
    ...
    get: function (a, b, c) {
      ...
      if (e && e[a])
        return (
          (c = e[a]),
          c[d] ? ((a = !1), !0 == c.C ? (a = !0) : (c.C = !0), (b = c[d](b)), a || (c.C = !1), b) : c.get(a, b)
        )
      if (!c && this[d])
        return (a = !1), !0 == this.C ? (a = !0) : (this.C = !0), (b = this[d](b)), a || (this.C = !1), b
  ...
  g.o = {
    ...
    key: '57308916576f11343a35498cc3f689c6',
    Cc: 'http',
        ...
        for (var a = window.localStorage.length; 0 <= a; a -= 1) {
          ...
          if (b && '_AMap_' === b.slice(0, 6)) {
            ...
            '_AMap_anole' === b
              ...
              ? (c.vdataVer === g.l.mf && c.apiVer === g.o.Fk) || window.localStorage.removeItem(b)
    ...
    g.ai = {
      lra: function (b) {
        ...
        if (g.l.ba) {
          ...
          d.push(
            '&ios=' +
              encodeURIComponent(
                'viewMap?sourceApplication=jsapi_q&dev=0&poiname=' + b.name + '&lat=' + b.y + '&lon=' + b.x
              )
          )
          d.push(
            '&android=' +
              encodeURIComponent('androidamap?action=shorturl&q=' + c.join(',') + '&sourceApplication=jsapi_q')
          )
          d.push(
            '&wp=' +
              encodeURIComponent(
      ...
      x4: function (b) {
        if (g.l.ba) {
          ...
          c.push(
            '&mo=' + encodeURIComponent(g.o.Mv + '/detail/index/poiid=' + b.id + '&sourceApplication=jsapi_detail')
          )
          return c.join('')
        }
      ...
      NR: function (b) {
        ...
        if (g.l.ba) {
          ...
          d.push(
            '&mo=' + encodeURIComponent(g.o.Mv + '/?r=' + c.join(',') + '&callapp=0&sourceApplication=jsapi_r_' + b.t)
          )
          return d.join('')
        }
  ...
  g.a = {
    ...
    eb: function (a) {
      if ('object' === typeof a && null !== a) {
        if (a.b7 || this.kk(a, 'Float32Array') || this.kk(a, 'Uint16Array')) return a
    ...
    find: function (a, b) {
      for (
        var c = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null, d = 0, e = a.length;
        d < e;
        d++
      )
    ...
    Bw: function (a, b) {
      ...
      for (m = a.length; l < m; l++)
        (f = a[l]), (f = c.indexOf(f)), isNaN(k) ? (k = f * d) : (h.push(k + f - e), (k = NaN))
      return h
    },
    vxa: function (a, b) {
      for (
      ...
      G3: function (b) {
        ...
        for (var d = 0, e = b.length; d < e; d++)
          if (
            ...
            b[d].ha &&
            b[d].ha.length &&
            (-1 !== b[d].ha.indexOf('building') || -1 !== b[d].ha.indexOf('poilabel')) &&
            b[d].Ra
          ) {
  ...
  ;(function (a) {
    ...
    a.extend(e.prototype, {
      ...
      pT: function (a) {
        this.E0 ? a.apply(null, this.E0) : (this.Tx || (this.Tx = []), this.Tx.push(a))
      },
      oy: function (b) {
        var c = this
        if (!c.LX) {
    ...
    if (!g.WL) {
      ...
      b.send = function (b) {
        var c = d.Cc + '://webapi.amap.com/count?',
          ...
          l = g.a
        b.params && b.params.rs && !b.params.type && ((b = a.DD[b.id].time), delete b.z5, (k = g.extend(k, b)))
        b = []
            ...
            return {
              ...
              yh: function (a, b) {
                var e = a.Od,
                  f = a.Je,
                  h = 'building' === a.ha[0]
                ;((f && e !== this.tx.oE && this.tx.oE) || (!f && !h && e !== this.tx.pk && this.tx.pk)) &&
                  this.Sla(!!f)
              ...
              Sla: function (a) {
                if (a) this.lX()
                  ...
                  for (var b in this.Tk) this.Tk.hasOwnProperty(b) && ((a = this.Tk[b]), a.Ot || a.abort())
              },
              Sya: function () {
                ...
                if (
                  ...
                  q.onreadystatechange = function () {
                    if (4 === q.readyState && 0 === q.status)
                      q.Ot || ((q.Ot = !0), f.Ml(l, b), (q.onreadystatechange = null), k ? f.J0(q) : delete f.Tk[q.AE]),
                        (q = null)
                    else if (!q.Ot)
                      if (3 === q.readyState) {
  ...
  g.f = {
    ...
    JD: function (a, b, c) {
      return a.parentNode == b
        ? !0
        : a.parentNode && a.parentNode !== document.body && !g.f.An(a.parentNode, c)
    ...
    dpa: function () {
      g.f.oea || ((g.f.oea = !0), (g.f.nea = 'ltr' === g.f.$c(document.body, 'direction')))
      return g.f.nea
    },
    ...
    g3: function () {
      ...
      this.kja || ((this.kja = document.onselectstart), (document.onselectstart = g.a.C3))
    },
    t3: function () {},
    Lya: function (a, b, c) {
    ...
    fb: function (a, b) {
      ...
      a &&
        ...
        (a.classList && a.classList.remove
          ...
          : (a.className = a.className.replace(/(\S+)\s*/g, c).replace(/(^\s+|\s+$)/, '')))
    },
    u4: function (a, b) {
      return 1 === b
        ? ''
    ...
    g9: function (a, b, c) {
      ...
      !c && g.l.TH
        ? ((b = g.f.L4(b)),
          ...
          1 < c.length ? ((c[0] = b), (a.style[g.f.qg] = c.join('rotate'))) : (a.style[g.f.qg] = b),
    ...
    rotate: function (a, b, c) {
      ...
      d
        ? ((a.style[d] = '' + (' rotate(' + b + 'deg)')), (a.style[g.f.qt[d] + '-origin'] = c.x + 'px ' + c.y + 'px'))
    ...
    H4: function (a, b, c) {
      ...
      return d
        ? g.f.qt[d] + ':' + ('' + (' rotate(' + b + 'deg)')) + ';' + (g.f.qt[d] + '-origin:' + c.x + 'px ' + c.y + 'px')
        : ''
    },
    zm: function (a, b, c) {
      a.width = b
  ...
  g.F = {
    h: function (a, b, c, d) {
      ...
      if (g.l.V7 && 0 === b.indexOf('touch')) return (a[h] = e), this.$la(a, b, e, f)
    ...
    jya: function (a) {
      ...
      g.l.O6 &&
        (g.F.h(a, 'MSPointerDown', b, this), g.F.h(a, 'MSPointerUp', b, this), g.F.h(a, 'MSPointerMove', b, this))
    },
    ...
    zxa: function (a) {
      return a && a.getBoundingClientRect
        ? ((a.uM = a.getBoundingClientRect()), (a.XW = [a.clientLeft, a.clientTop]), !0)
        : !1
    },
    Aza: function (a) {
      ...
      YGa: function (b, d) {
        ...
        b.Cp.length ||
          (c
            ...
            : (b.Dp.contentDocument.defaultView.removeEventListener('resize', a), (b.Dp = !b.removeChild(b.Dp))))
      },
      Jna: function (a) {
        a.Cp = null
        if (a.Dp) {
  ...
  ;(function () {
    ...
    function b(a) {
      var b = g.o.Fk + '|' + a.Pi.replace(/\//g, ',') + '|' + (a.Nf ? 'w' : 'v') + '|',
        c
      c = a.ja
      var d = a.Be
      ...
      var s = g.indexedDB,
        ...
        w = {
          ...
          setItem: function (a, b, c) {
            ...
            c &&
              ((d = JSON.stringify(b)),
              1.5 < d.length / 1024 / 1024 && Object.keys(b.nqa).length && ((b.nqa = {}), (d = JSON.stringify(b))))
            try {
            ...
            ? (f.forEach(function (a) {
                ...
                a
                  ...
                  ? (r.ka(u.data.keys, a) ||
                    ...
                    r.ka(v, a) && void 0 === u.data.fsTiles[a] && (u.data.fsTiles[a] = c))
                  : (b[a] = c)
              }),
              d.length &&
                (q.Oi
                  ? s.add(d, function (a) {
                      a
                        ? 3 !== a.code
                          ? e()
                          : (q.Oi = !1)
                        : ((u.data.keys = u.data.keys.concat(h)), w.setItem(u.key, u.data, !0), c())
                    })
                  : w.setItem(u.key, u.data, !0)),
              (u.rt = b))
  ...
  g.pe = g.da.extend({
    A: function () {
      ...
      if (1 === arguments.length && arguments[0] instanceof Array)
        (a = new g.U(arguments[0][0], arguments[0][1], !0)), (b = new g.U(arguments[0][2], arguments[0][3], !0))
      else if (2 === arguments.length) (a = g.a.Ka(arguments[0])), (b = g.a.Ka(arguments[1]))
      else if (4 === arguments.length)
        (a = new g.U(arguments[0], arguments[1])), (b = new g.U(arguments[2], arguments[3]))
    ...
    yi: function () {
      return new g.U(
        this.wc.R > this.oc.R ? ((this.wc.R + this.oc.R + 360) / 2) % 360 : (this.wc.R + this.oc.R) / 2,
  ...
  g.Bp.yW = {
    ...
    Xh: function (a, b) {
      for (
        ...
        (l = d * Math.sin(h)), (l = Math.PI / 2 - 2 * Math.atan(e * Math.pow((1 - l) / (1 + l), 0.5 * d)) - h), (h += l)
  ...
  z.Sb = g.da.extend({
    ...
    w: {
      ...
      copyright: '\x3c!--v1.4.16--\x3e &copy ' + new Date().getFullYear() + ' AutoNavi ',
      isHotspot: !g.l.ba,
      baseRender: g.l.Y1,
          ...
          d.w6(function () {
            d.map &&
              ...
              d.map.Se &&
                ...
                d.map.Se.je &&
                d.map.Se.je.S &&
                (d.map.Se.je.S.fI(), (d.map.Se.je.S.Q6 = c), d.map.Se.je.S.reload()),
              d.set('display'))
          })
        })
      }
        ...
        e.w6(function () {
          g.ub.Gg(f, function () {
            if (!e.get('destroy')) {
              ...
              e.C = !0
              '3D' === e.view.type &&
                (e.AmbientLight || (e.AmbientLight = new g.Vw.TV([1, 1, 1], 0.9)),
    ...
    w6: function (a) {
      try {
        ...
        if (b)
          if (((g.SJ = 0), (g.RJ = 0), 'string' == typeof b && 'style_' == b.substr(0, 6))) {
            var c = this,
              d,
              e = b.slice(6)
            32 == e.length
              ? ((c.ls = !0),
                ...
                (d += '&sdkversion=' + g.o.Xl),
                g.o.Xa && (d += '&jscode=' + g.o.Xa))
              : ((c.ls = !1), (g.o.hqa = g.o.UI + b + '/'), (d = g.o.Hb + '/styles/foreign/web_v8_' + b + '.json'))
            ...
            f.h(
              ...
              function (b) {
                if (b && b.data && !b.data.TDa) {
                  ...
                  ;(d = b.style) &&
                    d.layers &&
                    ((g.Wta = d.layers), b.zoomlevel && ((g.SJ = b.zoomlevel[0]), (g.RJ = b.zoomlevel[1])))
      ...
      if (g.l.Ve || g.Ue) a()
        ...
        if (c) b(), a()
          ...
          f.src =
            ...
            g.o.Cc + '://vdata.amap.com/style?v=' + g.o.Xl + '&key=' + g.o.key + '&mapstyle=normal'
          c = document
    ...
    Txa: function (a, b) {
      ...
      e &&
        ...
        (this.ex.Kq = function (b) {
          ...
          for (var c in b)
            b.hasOwnProperty(c) &&
              ('center' === c ? ((this.C = !0), this.setCenter(b[c], !0), (this.C = !1)) : this.set(c, b[c]))
        }),
        this.ex.On(this))
    },
    Aoa: function (a) {
    ...
    fQ: function () {
      ...
      if (this.view && '3D' !== this.view.type) {
        ...
        if (a && !('dv' < a)) {
          ...
          b &&
            c &&
            (g.l.Yp && (d || 'all' !== b || ('normal' !== c && 'amap://styles/normal' !== c))
    ...
    layersChanged: function () {
      ...
      for (var b = 0; b < a.length; b += 1)
        (a[b].C = !0), a[b].getMap() !== this && a[b].setMap(this), (a[b].C = !1), a[b].aK && (this.aK = !0)
      this.OU()
    },
    ...
    uC: function (a) {
      ...
      0 <= g.a.indexOf(b, a) ||
        (a instanceof z.B.Un
          ...
          : (a instanceof z.B.Ze && (this.tm instanceof z.B.Ze && this.Lz(this.tm), (this.tm = a)),
            this.get('overlays').push(a)),
        this.r('overlays'))
    },
    uk: function (a) {
    ...
    setZoom: function (a, b) {
      ...
      this.get('zoomEnable') &&
        (b || !this.loaded
          ? (this.set('zoom', a), this.r('zoomstart'), this.r('zoomchange'), this.r('zoomend'))
          : this.set('zoomSlow', a))
    },
    getZoom: function (a) {
    ...
    getAllOverlays: function (a, b) {
      ...
      if (d)
        for (var f = 0, h = d.length; f < h; f += 1)
          d[f] instanceof z.q.PL && e.push(d[f]), d[f].lb && (e = e.concat(d[f].lb))
      return c.concat(e)
    },
    ...
    getLayers: function () {
      ...
      if (this.C) {
        ...
        for (b = a.length; -1 < --b; )
          (c = a[b]), c.$A && a.splice(b, 1), c.WV && 'AMap.TileLayer.Watermark' === c.WV && a.splice(b, 1)
      return a
    },
    ...
    isForeignMapVisible: function () {
      if (this.get('gridForeignMap') || this.get('vectorForeignMap')) return this.map && this.map.Ega()
    },
    Zd: function (a, b, c) {
    ...
    queryObjectIndexFromFboByContainerPos: function (a, b) {
      ...
      if (c) (this.$G = this.view.Me.eb()), (this.ZG = this.view.dc.eb())
        ...
        if (((c = this.ZG.$u(this.view.dc)), (c = !(this.$G.$u(this.view.Me) && c))))
  ...
  z.Sb.Ib({
    isHotspotChanged: function () {
      if ('undefined' !== typeof this.wD && (this.Pna(), this.get('isHotspot'))) {
        var a = this.get('layers', null, !0)
    ...
    removeListener: function (a) {
      a instanceof g.uF &&
        (g.a.Qh(a.Bi.removeListener)
          ...
          : 1 === a.type && (a.Bi.we || (a.Bi.we = g.va.we), g.va.G.call(a.Bi, a.YQ, a.fS, a.cf)))
    },
    O: function (a, b) {
  ...
  z.q.Zb = g.da.extend({
    ...
    setMap: function (a) {
      ...
      else if (b && (b.uk(this), this.set('map', null, !0), (this.ri = !1), this.hg && this.hg(), this.onRemove))
        this.onRemove()
    },
    getMap: function () {
      g.c.add(this, 'getMap')
  ...
  z.q.mb = z.q.Zb.extend({
    ...
    A: function (a) {
      ...
      var b = a.zooms
      b && b[1] >= this.qk[0]
        ? (b[0] < this.qk[0] && (b[0] = this.qk[0]), b[1] > this.qk[1] && (b[1] = this.qk[1]))
    ...
    cg: function (a) {
      ...
      if (this.Wv) return new g.q.mb(this, a, this.Ar(this.D4(!0)), this.w.maxDataZoom, !0)
      if (b)
        if (((this.Hq = !0), g.q.fi)) {
          ...
          if ('v' <= c.get('baseRender') || this.get('watermark'))
            return (
              '3D' == a.D.view.type
                ...
                : ((c = new g.q.qd(this, a, ['region', 'building', 'road'])), (c.type = '\u77e2\u91cf\u5e95\u56fe')),
              (a.Ema = c)
            )
    ...
    setTileUrl: function (a) {
      ...
      this.A2() ? (this.set('getTileUrl', a), this.ct()) : this.set('getTileUrl', a)
    },
    Ar: function (a) {
      var b = this,
        c,
  ...
  z.q.mb.RW = z.q.mb.extend({
    w: {
      getTileUrl: function (a, b, c) {
        return (
          g.o.Cc + '://tm.amap.com/trafficengine/mapabc/traffictile?v=1.0&t=1&zoom=' + (17 - c) + '&x=' + a + '&y=' + b
        )
      },
      zooms: [6, 20],
      zIndex: 4,
  ...
  z.q.baa = z.q.Zb.extend({
    ...
    cg: function (a) {
      if (g.l.Yp) return (a = new g.q.Kba(this, a)), (a.az = this.get('heightFactor') || 1), a
    },
    setStyle: function (a) {
  ...
  z.q.Xaa = z.q.Zb.extend({
    ...
    A: function (a, b) {
      ...
      g.l.kl &&
        ...
        this.setData(a),
        g.a.vb(this, b),
        b.style ? (this.kf(this.w, !0), this.setStyle(b.style)) : this.setStyle(this.w),
        (this.C = !1))
    },
    clear: function () {
      g.c.add(this, 'clear')
    ...
    setMap: function (a) {
      ...
      g.l.kl &&
        (a
          ...
          : this.get('map') &&
            (this.get('map').uk(this), this.set('map', null, !0), (this.ri = !1), this.hg && this.hg()))
    },
    cg: function (a) {
      return g.ub.KD(['cvector']) ? ((a = new g.q.hd(this, a)), this.X('datas', a), a) : ['cvector']
    },
  })
  ...
  z.q.sr = z.q.Zb.extend({
    ...
    MU: function (a, b) {
      var c = this.rP
      a && (b ? (c && c._LabelMarkerId !== a._LabelMarkerId && c.setTop(!1), (this.rP = a)) : (this.rP = null))
    },
    zR: function (a) {
  ...
  z.q.PL = z.q.DA.extend({
    ...
    mapChanged: function () {
      this.get('map') &&
        ...
        this.get('clickable') &&
          ((this.K2 = z.event.addListener(this.get('map'), 'click', this.Vua, this)),
  ...
  z.B.Fh = g.da.extend({
    ...
    setMap: function (a) {
      ...
      a !== this.get('map', null, !0) &&
        (a
          ? (this.get('map', null, !0) && this.get('map', null, !0).Lz(this), this.set('map', a))
          : this.get('map', null, !0) && (this.get('map', null, !0).Lz(this), this.set('map', null, !0)))
    },
    getMap: function () {
      g.c.add(this, 'getMap')
      return this.get('map', null, !0)
  ...
  z.B.Oaa = z.B.Fh.extend({
    ...
    getBounds: function () {
      ...
      try {
        return (
          'string' === typeof a
            ? (a = new g.U(a.split(',')))
            : '[object Array]' == Object.prototype.toString.apply(a) && (a = new g.U(a[0], a[1])),
          new g.pe(a, a.eb())
        )
      } catch (b) {
        return null
    ...
    setTop: function () {
      ...
      a ? ((this.Fca = this.w.zIndex), this.setzIndex(this.Zaa)) : this.setzIndex(this.Fca || this.w.zIndex)
    },
    getVisible: function () {
      g.c.add(this, 'getVisible')
  ...
  z.B.Un = z.B.Fh.extend({
    ...
    open: function (a, b) {
      ...
      this.set('position', b)
      this.map
        ? this.map && this.map !== a && (this.map.Lz(this), (this.map = a), this.setMap(a))
  ...
  ;(function (a) {
    ...
    function c(a, b, c, d, e) {
      ...
      return [
        ...
        (e[1] - b[1] - s - c) * Math.pow(a, 3) + c * Math.pow(a, 2) + s * a + b[1],
      ]
    }
    function d(a, c, d, e) {
    ...
    function h(b, f, h, n, p, q) {
      ...
      if (b && h && h.length) {
        ...
        for (var s = (r = 0), u = 0, v = b.length; u < v - 1; u++)
          var w = b[u], t = b[u + 1], r = r + Math.abs(t[0] - w[0]), s = s + Math.abs(t[1] - w[1])
        a: {
  ...
  z.B.Ec = z.B.gM.extend({
    ...
    getArea: function () {
      ...
      for (var a = this.get('path', null, !0), a = this.eK(a), b = 0, c = 0, d = a.length; c < d; c += 1)
        for (var e = a[c], b = b + this.B4(e[0]), f = 1; f < e.length; f += 1) b -= this.B4(e[f])
  ...
  z.B.hh = z.B.hd.extend({
    ...
    reset: function () {
      ...
      this.B &&
        this.B.get('deltaPos') &&
        ((a = this.B.Ut([a], this.B.get('deltaPos'))[0]), this.B.set('deltaPos', [0, 0], !0))
      this.set('center', a)
    },
  ...
  z.B.$V = z.B.hh.extend({
    A: function (a) {
      ...
      void 0 === a.radius
        ? (a.radius = 20)
        : g.a.kk(a.radius, 'string') && ((a.radius = parseFloat(a.radius)), isNaN(a.radius) && (a.radius = 20))
  ...
  z.B.Nt = z.B.Ec.extend({
    ...
    Wr: function () {
      ...
      if (b) {
        ...
        b.C = !1
        g.a.Ub(
          [new g.U(c.R, c.Q, !0), new g.U(d.R, c.Q, !0), new g.U(d.R, d.Q, !0), new g.U(c.R, d.Q, !0)],
          function (b) {
            return a.push(b)
          }
        )
  ...
  ;(function (a, b) {
    ...
    a.B.kW = a.B.Xn.extend({
      ...
      eda: function (c) {
        for (
          var d = 'Feature' === c.type ? c.geometry : c, d = d ? d.coordinates : null, e = [], f = 0, n = d.length;
          f < n;
          f++
        )
          e.push(
      ...
      JX: function (a) {
        for (
          var b = 'Feature' === a.type ? a.geometry : a, b = b ? b.coordinates : null, c = [], d = 0, e = b.length;
          d < e;
          d++
        )
    ...
    a.B.Xn.Ib({
      toGeoJSON: function (a) {
        ...
        for (var e = [], f = 0, m = a.length; f < m; f++)
          a[f].toGeoJSON && ((a[f].C = !0), (e[f] = a[f].toGeoJSON()), (a[f].C = !1))
        this.C = !0
        a = this.getExtData() || {}
        this.C = !1
        if (c(e, 'Point'))
  ...
  g.yd = {
    ...
    vq: function (a) {
      for (var b = a.length, c = 0, d = a[b - 1], e = d[0], d = d[1], f, h, k = 0; k < b; k += 1)
        (h = a[k]), (f = h[0]), (h = h[1]), (c += (f - e) * (h + d)), (e = f), (d = h)
      return 0 < c
    },
    Ud: function (a, b, c) {
      var d = a[0]
    ...
    a.extend(e.prototype, {
      ...
      distanceToLine: function (a, b) {
        ...
        for (var c = Infinity, d = 0, e = b.length; d < e - 1; d++)
          var n = this.closestOnSegment(a, b[d], b[d + 1]), c = Math.min(c, this.distance(a, n))
        return c
      },
      ...
      doesRingRingIntersect: function (a, b, c) {
        ...
        for (var d = 0, e = a.length; d < e; d++)
          if (this.doesSegmentRingIntersect(a[d], a[d === e - 1 ? 0 : d + 1], b, c)) return !0
        return !1
      },
      HP: function (a, b) {
        for (var c = 0, d = 0; d < a.length - 1; d += 1) {
          ...
          if (e + c < b) c += e
            ...
            return (c = (b - c) / e), [a[d][0] + c * (a[d + 1][0] - a[d][0]), a[d][1] + c * (a[d + 1][1] - a[d][1]), d]
        }
        return null
      },
      ZX: function (a, b) {
        ...
        for (var s = 0, u = b.length; s < u; s++) {
          ...
          for (var w = 0, t = v.length; w < t; w++)
            (q = v[w]), d(q) ? (d(p) || r.push(c()), r.push(q)) : d(p) && r.push(c()), (p = q)
          e = n
        }
        return r
      },
    ...
    a.tF = function () {
      ...
      function c(a, b) {
        ...
        var c = a,
          d
        do
          if (((d = !1), c.A9 || (!m(c, c.next) && 0 !== l(c.Ia, c, c.next)))) c = c.next
          else {
            s(c)
            c = b = c.Ia
            if (c === c.next) break
      ...
      function d(a, b, e, f, r, u, C) {
        if (a) {
          if (!C && u) {
            var D = a,
              A = D
            do null === A.z && (A.z = h(A.x, A.y, f, r, u)), (A.kp = A.Ia), (A = A.pl = A.next)
            while (A !== D)
            A.kp.pl = null
            A.kp = null
            var D = A,
            ...
            do {
              ...
              for (I = 0; A; ) {
                ...
                for (L = M; 0 < P || (0 < L && G); )
                  0 !== P && (0 === L || !G || A.z <= G.z) ? ((B = A), (A = A.pl), P--) : ((B = G), (G = G.pl), L--),
                    H ? (H.pl = B) : (D = B),
                    (B.kp = H),
                    (H = B)
                A = G
                  ...
                  do
                    (G = A.Ia),
                      ...
                      !m(G, H) &&
                        ...
                        p(G, H) &&
                        p(H, G) &&
                        (C.push(G.xe / D), C.push(A.xe / D), C.push(H.xe / D), s(A), s(A.next), (A = a = H)),
                      (A = A.next)
                  while (A !== a)
                  a = A
                  d(a, b, e, f, r, u, 2)
                                  ...
                                  if (((A = void 0), (A = p(C, D))))
                                    if (((A = void 0), (A = p(D, C)))) {
                                      ...
                                      do
                                        A.y > I !== A.next.y > I &&
                                          A.next.y !== A.y &&
                                          H < ((A.next.x - A.x) * (I - A.y)) / (A.next.y - A.y) + A.x &&
                                          (G = !G),
                                          (A = A.next)
                                      while (A !== C)
                                      A = G
      ...
      function f(a, b) {
        ...
        for (var l = h, m = h.x, n = h.y, r = Infinity, s, c = h.next; c !== l; )
          d >= c.x &&
            ...
            ((s = Math.abs(e - c.y) / (d - c.x)), (s < r || (s === r && c.x > h.x)) && p(c, a) && ((h = c), (r = s))),
            (c = c.next)
        return h
      }
      ...
      return {
        oL: function (h, k, l) {
          ...
          if (h.length > 80 * l) {
            ...
            u = m = h[1]
            for (H = l; H < n; H += l)
              (G = h[H]), (k = h[H + 1]), G < s && (s = G), k < u && (u = k), G > B && (B = G), k > m && (m = k)
            B = Math.max(B - s, m - u)
            B = 0 !== B ? 1 / B : 0
          }
          d(p, r, l, s, u, B)
  ...
  $.Browser = {
    ...
    isWebGL: function () {
      for (
        var a = document.createElement('canvas'), b = ['webgl', 'experimental-webgl', 'moz-webgl'], c = null, d = 0;
        d < b.length;
        d += 1
      ) {
        try {
  ...
  g.Sb = g.da.extend({
    ...
    styleUrlChanged: function () {
      if (this.D.Ci) {
        ...
        if (a !== this.Dm) {
          ...
          if ('normal' === c)
            (this.Dm = ''), this.set('nolimg', !!this.D.get('nolimg_param')), this.set('style', ''), (this.Pu = '')
          else {
            this.jA = !0
            this.set('nolimg', !0)
            var d
            32 > c.length
              ? (d = g.o.Cc + '://webapi.amap.com/style2?name=' + c + '&key=' + g.o.key)
              : ((d =
                  g.o.Cc +
                ...
                g.o.Xa
                  ? (d += '&jscode=' + g.o.Xa)
                  : g.o.fv &&
                    (d = g.o.fv + '/v4/map/styles2?styleid=' + c + '&s=rsv3&key=' + g.o.key + (b ? '&ispublic=1' : '')))
            b = new g.kb.Ab(d, {
              callback: 'callback',
            })
            b.h(
    ...
    sna: function () {
      ...
      if (!a.contains(b)) {
        ...
        a.wj() < b.wj()
          ? (c.R = a.yi().R)
          : (a.wc.R > b.wc.R && (c.R += a.wc.R - b.wc.R), a.oc.R < b.oc.R && (c.R += a.oc.R - b.oc.R))
        a.uj() < b.uj()
          ? (c.Q = a.yi().Q)
          : (a.wc.Q > b.wc.Q && (c.Q += a.wc.Q - b.wc.Q), a.oc.Q < b.oc.Q && (c.Q += a.oc.Q - b.oc.Q))
        return c
      }
    },
    ZO: function () {
    ...
    Asa: function () {
      ...
      350 < g.f.nJ(this.K).width &&
        ((b.sn.innerHTML = this.D.w.copyright), (b.sn.B6 = g.f.create('span', b.sn, 'amap-mcode')), this.vE())
      this.Ya = b
    },
    vE: function () {
      ...
      if (a) {
        ...
        c &&
          this.Ya.sn.B6 &&
          ((this.Ya.sn.B6.innerHTML = '- ' + c + '\u53f7'), (this.Ya.sn.style.visibility = 'visible'))
        return c
      }
    },
    EY: function () {
      ...
      if (!this.xI)
        if (this.QS) this.EY()
          ...
          var d = this,
            ...
            f = a()
          e
            ? (e.q && e.q.Ra && (this.D.Ra || c()), f && (this.D.Ra || c(), this.gU(), b()))
    ...
    controlsChanged: function () {
      ...
      if (a.add && 0 < a.add.length)
        for (; 0 < a.add.length; ) (b = a.add.shift()), (c = b.zu || b.addTo) && c.call(b, this.D, this.Ya.controls)
      else if (a.remove && a.remove.length)
        for (; 0 < a.remove.length; )
          (b = a.remove.shift()), (c = b.Yv || b.removeFrom) && c.call(b, this.D, this.Ya.controls)
    },
    E1: function () {
      if (!this.xI) {
        var a = this
          ...
          -1 === g.a.indexOf(b, a.Wc[d].Mb) &&
            (a.Wc[d].Mb instanceof z.B.Ze || a.Wc[d].Mb instanceof z.B.Un
              ...
              : (a.vd && a.Wc[d] instanceof g.B.wb
                  ? ((a.vd.bh = g.a.Ey(a.vd.bh, a.Wc[d].L)), a.vd.q8([a.Wc[d].L]))
        ...
        e.length && a.vd.ey(e)
        f.length &&
          (a.at || ((a.at = new g.q.hd(new z.q.hd(), a)), a.at.set('zIndex', 110), a.la.push(a.at)), a.at.ey(f))
        a.set('display', 0)
      }
    },
      ...
      if (!this.xI) {
        ...
        if (this.la && ((a.size = this.D.get('size')), a.size.width && a.size.height)) {
          ...
          for (d = 0; d < this.la.length; d += 1)
            this.la[d].S.QP &&
              a.lU &&
              (!this.fj && this.la[d].S.get('visible') && ((f = this.la[d].S.QP()), (f.rFa = 1), (f.zoom = a.P.zoom)),
              (c = !0))
          this.pb = []
    ...
    drawChanged: function () {
      ...
      if (d) {
        ...
        for (b = 0, c = this.uq.length; b < c; b += 1)
          this.uq[b].Ewa(), this.uq[b].mDa(), this.G('click', this.uq[b].ZEa, this)
    },
    Zd: function (a, b, c) {
      ...
      for (l = 0; l < k.length; l += 1) {
        ...
        if (g.f.An(m, 'amap-layer') || g.f.An(m, 'amap-e') || g.f.An(m, 'amap-labels'))
          if ('CANVAS' === m.tagName) {
            ...
            for (
              var r = m.childNodes, s = parseFloat(m.style.top) || 0 + c, m = parseFloat(m.style.left) || 0 + e, u = 0;
              u < r.length;
              u += 1
            ) {
              var v = r[u]
  ...
  g.Sb.Ib({
    ...
    zoomEnableChanged: function () {
      this.get('zoomEnable')
        ? (g.l.Uf && this.SP && '3D' !== this.D.view.type && this.SP(), g.l.ba || this.Lca())
    ...
    Mi: function (a, b, c, d) {
      ...
      e &&
        ...
        ((f.lnglat = f.Of), (f.pixel = f.Db), (f.target = e), (f.data = e.$W), (f.originEvent = a))
    ...
    UO: function () {
      ...
      a.gg &&
        (a.bk.Db.x === a.gg.x && a.bk.Db.y === a.gg.y
          ? (a.Kf = !1)
          : ((a.Kf = !0), a.Gp || (a.kq.r('dragstart', a.jq), (a.Gp = !0)), a.kq.r('dragging', a.bk), (a.gg = a.bk.Db)))
    },
    bya: function (a) {
  ...
  g.Sb.Ib({
    ...
    u7: function () {
      2 !== this.jB && 12 === this.get('zoom') && ((this.jB = 1), g.a.lR.start(this.JY))
      this.fj = !0
    },
    t7: function () {
      1 === this.jB && 13 !== this.get('zoom') && ((this.jB = 0), g.a.lR.cancel(this.JY))
      this.fj = !1
      this.set('display')
    },
    $0: function (a, b) {
    ...
    IM: function () {
      this.ZC &&
        ('3D' === this.D.view.type
          ? (this.h('dragstart', this.N_), this.h('dragging', this.J_), this.h('dragend', this.L_))
          : (this.h('dragstart', this.M_), this.h('dragging', this.I_), this.h('dragend', this.K_)))
    },
    BO: function () {
      this.ZC ||
        ('3D' === this.D.view.type
          ? (this.G('dragstart', this.N_), this.G('dragging', this.J_), this.G('dragend', this.L_))
          : (this.G('dragstart', this.M_), this.G('dragging', this.I_), this.G('dragend', this.K_)))
    },
    M_: function (a) {
      this.ZS(a)
      this.ou()
    ...
    I_: function () {
      ...
      if (c || b) {
        ...
        this.yv &&
          (this.ih
            ? ((a = new Date()), (this.$t = 100 < a - this.ih ? new g.H(0, 0) : new g.H(b, c)), (this.ih = a))
            : (this.ih = new Date()))
        this.qa('dragging')
        this.qa('mapmove')
        ...
        if (this.V.Kf) {
          ...
          this.Ie.Kq = function (a) {
            if (2 > Math.abs(a.x) && 2 > Math.abs(a.y))
              this.Ie.stop(), this.r('moveend'), this.ws(), (this.$t = this.ih = null)
            else {
              var b = a.x,
                e = a.y,
                f = this.rotation
  ...
  g.PF = g.TW.extend({
    lm: function () {
      var a = this.get('size'),
        ...
        c = (Math.PI * c) / 180,
        a = new g.H(
          (Math.abs(a.width * Math.cos(c)) + Math.abs(a.height * Math.sin(c))) / 2,
    ...
    uqa: function (a) {
      var b = this.get('size'),
        ...
        d = (Math.PI * d) / 180,
        b = new g.H(
          (Math.abs(b.width * Math.cos(d)) + Math.abs(b.height * Math.sin(d))) / 2,
  ...
  g.Sb.Ib({
    ...
    sA: function (a, b, c, d) {
      ...
      if (e !== a) {
        ...
        this.Wf &&
          this.Wf.dw &&
          (this.Wf.stop(), (d = !0), this.Wf.uD && (m = !0), (this.Wf = null), this.set('targetLevel', null))
    ...
    YK: function (a, b, c, d) {
      ...
      this.Wf &&
        this.Wf.dw &&
        (this.Wf.stop(), (b = !0), this.Wf.uD && (k = !0), (this.Wf = null), this.set('targetLevel', null))
      this.Hd &&
        this.Hd.dw &&
        (this.Hd.stop(),
        this.Hd.hS && (b = !0),
      ...
      if (f || h) {
        ...
        if (c)
          ...
          this.Hd.Kq = function (b) {
            0.02 > b
              ? (this.Hd && (this.Hd.stop(), (this.Hd = null)),
                f && (this.set('zoom', a), this.qa('zoomchange'), this.qa('zoomend'), (f = !1), this.r('zoomend')),
                h &&
                  (this.set('centerCoords', e),
                  this.r('mapmove'),
                  this.r('moveend', {
              ...
              : (f && this.set('zoom', a - l * b),
                h && ((b = e.bb(m.Pd(b)).toFixed(3)), this.set('centerCoords', b), this.qa('mapmove')))
            this.set('display', 1)
          }
          this.Hd.On(this)
  ...
  g.pg = g.da.extend({
    ...
    yza: function (a) {
      ...
      0 === this.count
        ...
        : ((this.dd.next.Ia = a), (a.next = this.dd.next), (a.Ia = this.dd), (this.dd.next = a))
      this.count += 1
    },
    Cua: function () {
      if (this.count) {
    ...
    vB: function (a) {
      this.WF
        ? ((a.next = this.dd.next), (a.Ia = this.dd), (this.dd.next = a), (a.next.Ia = a))
        : ((a.Ia = this.dd.Ia), (a.next = this.dd), (this.dd.Ia = a), (a.Ia.next = a))
    },
    z1: function (a) {
  ...
  function Sc(a, b, c) {
    ...
    a.a6 ? (a.a6.ui(), (a.a6 = null)) : d && ((d.onload = null), (d.onerror = null), (d.onabort = null), (a.Ba = null))
  }
  g.yF = g.da.extend({
    ...
    QM: function (a) {
      a && this.Mn.count >= this.R2 && ((a = this.Mn.dd.Ia.value), a.rn && (this.Mn.remove(a.url), this.kX(a)))
      for (; this.Pq.count && !(this.Mn.count >= this.R2); ) this.lea(this.Pq.shift())
    },
    Zga: function () {
      if (!this.UX) {
        this.UX = !0
  ...
  g.q.hd = g.q.Zb.extend({
    ...
    dataSourcesChanged: function () {
      ...
      a && a.length
        ? 'string' === typeof a
          ...
          : a.length &&
            (this.E7(a), (this.ns = a), (this.om = !0), this.set('display'), (this.Ra = !0), this.S.r('complete'))
        : this.clear()
    },
    getDatas: function () {
      return this.ns
      ...
      if (a) {
        ...
        if (a.rules) {
          for (var b = a.rules, d = 0, e = b.length; d < e; d += 1) {
            for (var f = [], h = b[d].symbolizers, k = 0, l = h.length; k < l; k += 1)
              h[k].fill && (f[k] = new g.style.Og.hW(h[k].fill)), h[k].stroke && (f[k] = new g.style.Og.MW(h[k].stroke))
            h = f
            b[d].gL = h
        ...
        if (a.symbolizers) {
          ...
          for (d = b.length; a < d; a += 1)
            b[a].fill && (b[a] = new g.style.Og.hW(b[a].fill)), b[a].stroke && (b[a] = new g.style.Og.MW(b[a].stroke))
          c.gL = b
        }
        a = new g.oM(c)
      } else a = new g.oM({})
    ...
    rwa: function (a) {
      'px' === a.target.get('unit')
        ? ((this.Bf = Math.max(a.ul, this.Bf)), (this.jg = Math.max(a.ul, this.jg)))
        : a.ul > this.Ps && ((this.Ps = a.ul), (this.rz = this.Ps / this.map.D.nj.oq(20)))
    },
    QH: function (a) {
      this.gm.add(a)
      if (!this.YC && !this.S.Aj) {
        if (0 === a.name.indexOf('circle') || 0 === a.name.indexOf('ellipse')) {
          ...
          'px' === a.get('unit')
            ? ((this.Bf = Math.max(b, this.Bf)), (this.jg = Math.max(b, this.jg)))
            : this.Ps
            ? b > this.Ps && ((this.Ps = b), (this.rz = this.Ps / this.map.D.nj.oq(20)))
    ...
    featureChanged: function (a) {
      ...
      var b = a.target,
        c = b.fc()
      0 !== this.gm.Qqa([g.a.zb(b)]).length && (this.gm.remove(b, a.Pv), c && !a.Poa && this.gm.add(b))
    },
    q8: function (a) {
      this.om = !0
      for (var b, c = 0, d = a.length; c < d; c += 1) (b = a[c]), (b.W.Pv = null), b.vs(!0), b.yl('feature')
    },
    KHa: function (a, b) {
  ...
  g.q.raa = g.da.extend({
    ...
    remove: function (a, b) {
      var c = g.a.zb(a).toString(),
        d = a.fc()
      this.sq[c] && ((this.sq[c] = null), d && ((c = 'undefined' !== typeof b ? b : d.Md()), this.RT.remove(c, a)))
    },
  })
  g.Mk = g.da.extend({
    A: function (a) {
      ...
      do {
        ...
        for (var h = f.length - 1; 0 <= h; h -= 1) {
          ...
          var l = g.Mk.Vz(k.I[2] - k.I[0], k.I[3] - k.I[1], k.Kb.length + 1),
            k = g.Mk.Vz(
              (k.I[2] > a.I[2] ? k.I[2] : a.I[2]) - (k.I[0] < a.I[0] ? k.I[0] : a.I[0]),
              (k.I[3] > a.I[3] ? k.I[3] : a.I[3]) - (k.I[1] < a.I[1] ? k.I[1] : a.I[1]),
              k.Kb.length + 2
            )
      ...
      if (0 === b.Kb.length) (b.I = g.I.eb(a.I)), b.Kb.push(a)
        ...
        do {
          ...
          if ('undefined' !== typeof e.We || 'undefined' !== typeof e.Kb || f) {
            ...
            else (e = f = this.sta(c.Kb)), 1 > d.length && (c.Kb.push(f[0]), d.push(c), (e = f[1]))
          } else
            g.I.extend(c.I, e.I),
              (e = {
                I: g.I.eb(c.I),
      ...
      do {
        ...
        if ('undefined' !== typeof b)
          ...
          0 === d.length && 1 >= c.Kb.length
            ? ((h = this.Pz(c, !0, h, c)), (c.Kb.length = 0), d.push(c), e.push(1))
          ...
          if (g.I.$g(a.I, m.I))
            if ('undefined' !== typeof m.Kb) k.push(m.Kb)
              ...
              if (b) c.push(m)
                ...
                (m = m.We), 'undefined' !== typeof f ? (h[g.a.zb(m)] = m) : c.push(m)
        }
      } while (0 < k.length)
  ...
  g.B.wb = g.B.Fh.extend({
    ...
    raiseOnDragChanged: function () {
      this.get('raiseOnDrag')
        ? (this.h('dragstart', this.D0, this), this.h('dragging', this.sg, this), this.h('dragend', this.pY, this))
        : (this.G('dragstart', this.D0, this), this.G('dragging', this.sg, this), this.G('dragend', this.pY, this))
    },
    ap: function (a) {
    ...
    offsetChanged: function () {
      function a(a) {
        ...
        f &&
          ...
          2 === f.length
            ? ((k = f[1]), (h = f[0]))
            : 1 === f.length && 'center' === f[0] && ((k = 'center'), (h = 'middle')))
        switch (k) {
          case 'center':
            l -= c / 2
            break
    ...
    UF: function () {
      this.L && ((this.L.Xj = null), (this.L.se = !0), this.map && ((this.map.vd.nm = !0), this.map.set('display')))
    },
    contentChanged: function () {
      if (this.L) {
        ...
        this.L.fa
          ? (g.l.Ai && g.a.iepngFix(a), this.L.fa.appendChild(a), (this.L.Vg = a), this.offsetChanged(), this.uL())
    ...
    labelChanged: function (a) {
      ...
      if (this.L && this.L.fa) {
        ...
        a &&
          a.content &&
          ((c = ''), a.content && ((c = this.XP(a.content)), b.appendChild(c), this.uL(a, c)), this.set('labelDom', c))
    ...
    isTopChanged: function () {
      ...
      a
        ? a === this
          ? this.L &&
            this.L.fa &&
            ((this.L.fa.style.zIndex = b ? this.map.vd.fr + 10 : c), (this.map.vd.lL = b ? this : null))
          : (a.L && a.L.fa && (a.L.fa.style.zIndex = b ? a.get('zIndex') : this.map.vd.fr + 10),
            this.L && this.L.fa && (this.L.fa.style.zIndex = b ? this.map.vd.fr + 10 : c),
            (this.map.vd.lL = b ? this : a))
        : ((this.map.vd.lL = this), this.L && this.L.fa && (this.L.fa.style.zIndex = b ? this.map.vd.fr + 10 : c))
    },
    visibleChanged: function () {
      this.L &&
        this.L.fa &&
    ...
    i2: function (a) {
      ...
      'string' !== typeof a
        ? b.appendChild(a)
        : ((b.innerHTML = a), b.childNodes[0] && !b.childNodes[0].style && (b.style['white-space'] = 'pre'))
    ...
    moveTo: function (a, b, c, d) {
      if (!(0 >= b)) {
        ...
        this.get('autoRotation') &&
          !g.l.Ve &&
          ((b = '2D' == (this.map.D.view.type || '2D') ? this.efa(e, a) : this.ffa(e, a)), this.set('angle', b))
        this.zh.On(this)
      }
    },
    lya: function () {
    ...
    vua: function (a, b, c, d) {
      ...
      function f() {
        a.Mp < a.length - 1
          ...
          : (this.qa('movealong'),
            d ? ((a.Mp = 0), this.set('position', a[0]), this.moveTo(a[a.Mp], b, c)) : this.r('movestop'))
      }
  ...
  g.B.Ze = g.B.Fh.extend({
      ...
      if (a) {
        ...
        if (b) {
          ...
          if ((a = this.get('size', !0)))
            0 !== a.width && (d.style.width = a.width + 'px'), 0 !== a.height && (d.style.height = a.height + 'px')
          this.get('anchor')
    ...
    Ida: function () {
      ...
      if (c) {
        ...
        c &&
          ...
          2 === c.length
            ? ((e = c[1]), (f = c[0]))
            : 1 === c.length && 'center' === c[0] && ((e = 'center'), (f = 'middle')))
        switch (e) {
          case 'left':
            h = 2
            break
      ...
      if (this.get('position') && this.get('autoMove') && this.qh) {
        for (
          var a = this.map,
            ...
            c = a.Ns(this.get('position'), this.get('altitude')).add(this.Ida()),
            d = c.add(b.RE()),
            e = a.get('size'),
            f = a.Dqa(),
            h = 0,
    ...
    Una: function () {
      this.get('closeWhenClickMap') &&
        (this.map.h('clickstart', this.F_, this, !1), this.map.h('clickend', this.E_, this, !1))
    },
    F_: function () {
    ...
    hg: function () {
      this.Rc &&
        ...
        ((this.sf.kL = !1),
        this.get('closeWhenClickMap') &&
          (this.map.G('clickstart', this.F_, this), this.map.G('clickend', this.E_, this)),
        this.get('retainWhenClose')
          ? this.map.Nl.appendChild(this.Rc)
          : (this.Rc.parentNode === this.map.Ya.B && this.map.Ya.B.removeChild(this.Rc), (this.sf.B = null)),
        (this.map = null),
        (this.sf.ri = !1),
        this.Mb.r('close', {
          type: 'close',
  ...
  g.bi = g.da.extend({
    ...
    FU: function (a) {
      a &&
        ...
        (a.X('radius', this), a.X('center', this), a.X('resolution', this), a.X('strokeWeight', this))
    },
    setStyle: function (a) {
      this.Pxa(a)
      this.vs()
    ...
    Lqa: function () {
      ...
      a.zi() === g.Aa.Qe.GF || a.zi() === g.Aa.Qe.CF
        ...
        : a.zi() === g.Aa.Qe.RL || a.zi() === g.Aa.Qe.tW || a.zi() === g.Aa.Qe.bM
        ? b.push(
            new g.style.Ce.yp({
              color: '#888888',
              width: 1,
  ...
  g.M.Zb = g.da.extend({
        ...
        if ((e = f.yn([a[0] - e, a[1] - h, a[0] + e, a[1] + h]))) {
          for (var q in e)
            if (e.hasOwnProperty(q) && ((h = e[q]), h.get('visible') && !h.get('noSelect')))
                ...
                if (this.Aj) {
                  ...
                  (l = k.za),
                    ...
                    'px' === h.get('unit')
                      ...
                      : m.He(l) * Math.cos((h.get('center').Q * Math.PI) / 180) <=
                          (k / this.Dq) * Math.pow(2, 20 - this.zoom) && c.push(h)
                else if ('AMap.Text' == h.Vp)
                  (l = h.get('params')), l.visible && h.fa && g.f.JD(d, h.fa, 'amap-markers') && c.push(h)
                else {
              ...
              else k.Ud ? k.Ud(a) && c.push(h) : k.Gy && 1.8 * k.Gy(a) <= h.get('strokeWeight') * this.T && c.push(h)
          this.Aj
            ? c.sort(function (a, b) {
            ...
            : c.sort(function (a, b) {
                return a.get('isTop')
                  ...
                  : b.get('isTop')
                  ? 1
                  : a.get('zIndex') > b.get('zIndex') || (a.get('zIndex') === b.get('zIndex') && a.hm > b.hm)
                  ? -1
                  : 1
              })
          b(c, f)
    ...
    ID: function (a, b, c) {
      ...
      if ('circle' === a.w.type) {
        ...
        if ('poly' === a.w.type) return (e = a.w.coords), (e = this.iI(e)), g.yd.Ud(d, e)
        if ('rect' === a.w.type)
          return (
            (e = a.w.coords),
            (a = e[0]),
    ...
    l4: function (a, b, c, d, e, f, h) {
      ...
      1 > f &&
        ('opacity' in a.style
          ...
          : 8 <= document.documentMode
          ? (k.push("-ms-filter:'progid:DXImageTransform.Microsoft.Alpha(opacity="),
  ...
  g.Y2 = {
    ...
    hra: function (a) {
      ...
      return function (a) {
        ...
        if (void 0 === e[a]) {
          var k = b.mD(a, d, e)
          e[a] =
            f && 'none' !== f && k.dK !== k.Iz && k.Nq !== k.YD ? c.K4(k.Nq, k.YD, (a - k.Iz) / (k.dK - k.Iz), f) : k.Nq
        }
        return e[a]
      }
    },
    ...
    Bqa: function (a, b, c) {
      ...
      e.Ub(a.nodes, function (a) {
        a.value && ((h[a.zoom] = e.nma(a.value, c ? 'rgba' : 'webgl')), f.push(a.zoom))
      })
      return function (a) {
        var b = null
        a = e.xb(a, 1)
      ...
      if (a)
        for (var e in a)
          if (a.hasOwnProperty(e) && g.a.kk(a[e], 'object')) {
            ...
            var h = e
            c && (h = c + ':' + e)
            if (f.detailedType) this.H7(f, b, h), this.ET(f.detailedType, b, h, f)
                ...
                if (h) {
                  ...
                  for (var k in h)
                    h.hasOwnProperty(k) &&
                      ...
                      ((c[d][f][k] = {}),
                      h[k].Ye
                        ? (b(h[k].Ye) ? (c[d][f][k].Ye = h[k].Ye(a)) : (c[d][f][k].Ye = h[k].Ye),
                          b(h[k].canvas) ? (c[d][f][k].canvas = h[k].canvas(a)) : (c[d][f][k].canvas = h[k].canvas))
                        : b(h[k])
                        ? (c[d][f][k] = h[k](a))
                        : (c[d][f][k] = h[k]))
                } else c[d][f] = h
    ...
    styleChanged: function () {
      if (this.e.D.Ci) {
        ...
        e &&
          e.visible &&
          ((m = this.hl(b.qp(this.e.MH.substr(1)), e.opacity, e.color, !0, a)), (m = this.Dt(m, e.visible)))
        f &&
          f.visible &&
    ...
    lq: function (a, b, c, d, e) {
      if (a) {
        if (void 0 !== b)
          return (
            (a = a.split(',')), (c = b), 'function' === typeof b && (c = b(e)), (a[3] = g.a.xb(c, 3) + ')'), a.join(',')
          )
    ...
    zs: function (a, b, c, d) {
      ...
      ;(e = this.sD(b, d)) &&
        (f =
          ('function' === typeof e.visible && !e.visible(d)) || !1 === e.visible ? '' : c(a, e.opacity, e.color, !1, d))
      ...
      r &&
        ...
        !1 === r.PU
          ...
          : ((h = this.lq(a, r.wya, r.vya, !1, f)),
            ...
            r.fontSize &&
              ((p = 'function' === typeof r.fontSize ? r.fontSize(f) : r.fontSize),
              (p = 12 <= p ? p : 12),
              (p = 22 >= p ? p : 22)),
            p && g.l.Kc && (p *= 2)))
      f = !1
    ...
    Oy: function (a, b, c, d, e) {
      ...
      if ((f = this.sD(c, e)))
        ('function' === typeof f.visible && !f.visible(l)) || !1 === f.visible
          ? (h = k = '')
          : ((h = d(a, f.me, f.fillColor, !1, l)), (k = d(b, f.rb, f.strokeColor, !1, l)))
  ...
  g.M.canvas.Sb = g.M.Sb.extend({
    ...
    pc: function (a) {
      ...
      this.Na.x - b.nb.x < -g.a.Fa / 2
        ...
        : this.Na.x - b.nb.x > g.a.Fa / 2 && (this.Na = new g.H(this.Na.x - g.a.Fa, this.Na.y))
        ...
        if (l && l.g)
          if (!m.visible || k.ZD || m.Za[0] > b.zoom || m.Za[1] < b.zoom || (k.ha && 0 === k.ha.length)) {
            ...
            if (!q || !k || (l.Di && !this.e.D.Ra))
              c[h].zj && k.parentNode !== this.K && (this.K.appendChild(k), (c[h].Ob = k))
            else {
              c[h].Ob = k
              k.length || ((k = [k]), (q = [q]))
              for (var r = 0; r < k.length; r += 1)
                if (((n = k[r]), (p = q[r]), !p.bz)) {
                  ...
                  c[h].YC
                    ? (w.push('top:' + Math.floor(f / 2 + u) + 'px'), w.push('left:' + Math.floor(e / 2 + s) + 'px'))
                    : n.Q5
        ...
        var e,
          ...
          p = (function () {
            ...
            for (e = a.length - 1; 0 <= e; e -= 1)
              for (f = a[e], h = [], k = [], f.$T = h, f.Ov = k, l = f.length - 1; 0 <= l; l -= 1)
                (m = f[l]),
                  (n = m.ta),
                  c.g.e.Se.PE(
                    n.x,
            ...
            for (var c = a.length - 1; 0 <= c; c -= 1) {
              ...
              if (d.length)
                if (l.Ei) {
                  ...
                  var e = d[0].ta.z
                  l.jw(d, l.ll ? 1 : 0)
                  for (var f = 0, h = 0; f < d.length; ) l.XS(d.slice(10 * h, 10 * h + 10), e, b), (f += 10), (h += 1)
                } else
                  for (
                    e = (function () {
                      var a = d.length
            ...
            if (((s[p + ''] |= 64), this.$i))
              for (
                ...
                for (p.x = x, y = w; y <= t; y += 1)
                  (p.y = y), (E = p + ''), (s[E] |= 32), (u[E] = u[E] ? Math.max(k.ta.z, u[E]) : k.ta.z)
          } else if (this.Zi)
            for (v = 1; p.z >= this.gb; ) {
              s[p + ''] |= v
              v = p.x >> 1
      ...
      for (x = e.Jc; x <= e.Ic; x += 1)
        for (p.x = x, y = e.hc; y <= e.tc; y += 1)
          (p.y = y),
            ...
            k.Ba
              ? ((k.fe = this.fe),
                this.xv(c, x, y) && (m.push(k), this.Jl && (k.jd !== this.jd || 1 > k.kx) && (v = !0)))
              : ((q = !1),
                this.xv(c, x, y) && (v = !0),
            ...
            (k = d[q]),
              ...
              y[k.key] ||
                ...
                k.Ba && (!this.jja || s[k.key] & 64)
                  ? ((p.x = Math.min(c.Ic, Math.max(c.Jc, p.x << (this.gb - r)))),
  ...
  g.M.ce.Ui = g.M.Ui.extend({
    ...
    Nz: function (a, b) {
      ...
      this.wg &&
        !this.g.Ra &&
        ((c = this.g), (c.Ra = !0), c.Ld ? c.qa('renderComplete') : ((c.Ld = !0), c.qa('complete')))
    },
    pc: function (a, b) {
      this.up = a.up
      this.hf = a.hf
              ...
              ? ((s = n.ld),
                ...
                0 !== v &&
                  ...
                  s.parentNode !== this.Ob &&
                    (g.l.Ai && 'overlayer' === this.g.get('type') && (s.style.display = 'none'),
  ...
  g.M.Le.Hl = g.M.Ui.extend({
    ...
    pc: function (a, b) {
      ...
      c = c.yn(e)
      for (d in c) c.hasOwnProperty(d) && ((c[d].fe = this.fe), (c[d].m6 = this))
      this.Zv(c)
      ...
      for (f in a)
        if (a.hasOwnProperty(f)) {
          ...
          n &&
            ...
            2 === n.length
              ? ((s = n[1]), (u = n[0]))
              : 1 === n.length && 'center' === n[0] && ((s = 'center'), (u = 'middle')))
          var t,
            n = (t = 0)
  ...
  if (Uc.Kv) {
    ...
    try {
      for (var Kc = 0, dd = Xc.length; Kc < dd; Kc++) {
        ...
        if (ed && ed.version === Oc.Fk) bd.push(ed.script), ed.css && cd.push(ed.css)
        else {
          bd = void 0
          ad = !1
          break
  ...
  function jd() {
    ...
    kd()
      ? ld(a)
      : (fa.write(
          '<script crossorigin="anonymous" id="amap_plus_js" src="' + a + '" type="text/javascript">\x3c/script>'
        ),
        setTimeout(function () {
  ...
  '57308916576f11343a35498cc3f689c6',
  [114.434945, 38.583943, 118.536708, 41.287731, 116.3683244, 39.915085],
  'https://webapi.amap.com',
  1,
  '1.4.27',
  null,
  '110000',
  'AMap.Autocomplete,AMap.Geocoder,AMap.Geolocation,AMap.PlaceSearch',
  true,
  false,
  false,
  true,
